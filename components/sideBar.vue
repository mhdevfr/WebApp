<template>
  <div
    class="flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-950"
    v-if="showSidebar"
    v-motion-slide-visible-right
  >
    <button @click="toggleSidebar" class="p-4">Open</button>
    <div class="flex flex-col items-center mt-3 border-t border-gray-700">
      ...
      <nuxt-link
        class="flex items-center justify-center w-12 h-12 mt-2 text-gray-200 hover:bg-gray-700 rounded"
        href="#"
      >
        <svg
          class="w-6 h-6 stroke-current"
    ...
    <nuxt-link
      to="/account"
      v-if="user"
      class="flex items-center justify-center w-16 h-16 mt-auto bg-green-800 hover:bg-gray-700 hover:text-gray-300"
    >
      <svg
        class="w-6 h-6 stroke-current"
        xmlns="http://www.w3.org/2000/svg"
  ...
  <div
    class="flex flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-gray-950"
    v-if="!showSidebar"
  ...
  >
    ...
    <div class="w-full px-2">
      ...
      >
        ...
        <nuxt-link
          class="flex items-center w-full h-12 px-3 mt-2 text-gray-200 hover:bg-gray-700 rounded"
          href="#"
        >
          <svg
            class="w-6 h-6 stroke-current"
