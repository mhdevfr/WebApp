<template>
  <div
    class="group duration-700 cursor-pointer group overflow-hidden relative text-gray-50 h-72 w-96 rounded-2xl hover:duration-700"
  >
    ...
    <div
      class="absolute bg-gray-50 -bottom-24 w-96 p-3 flex flex-col gap-1 group-hover:-bottom-0 group-hover:duration-600 duration-500"
    >
      ...
      <p class="text-neutral-800">
        This component is made from our website and AI app, powered by OpenAI.
      </p>
    </div>
  </div>
</template>
